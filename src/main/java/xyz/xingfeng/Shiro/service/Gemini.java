...
public class Gemini {
    ...
    public String post() throws Exception {
        ...
        map.put("Authorization", "Bearer sk-d4fd5f65f6194fab809b1dec00c9d23b");
        String post = NetRequest.post("https://api.deepseek.com/chat/completions", model.toString(), map);
